...
@CommandLine.Command(name = "HighFragTest", mixinStandardHelpOptions = true,
        description = "HighFragTest repro.")
public class HighFragTest implements Callable<Integer> {

    public static void main(String... args) {
        int exitCode = new CommandLine(new HighFragTest()).execute(args);
    ...
    int num_loaders_per_generation = 5;
    int num_classes_per_loader = 400;
